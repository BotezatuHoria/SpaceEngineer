...
SELECT IdQuestion, Question, Explanation, Subject FROM Questions WHERE (IdQuestion = @IdQuestion)";
    ...
    public partial class MaterialsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Materials] WHERE (([Id] = @Original_Id) AND ((@IsNull_Subject " +
                "= 1 AND [Subject] IS NULL) OR ([Subject] = @Original_Subject)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Materials] SET [Name] = @Name, [Subject] = @Subject WHERE (([Id] = " +
                "@Original_Id) AND ((@IsNull_Subject = 1 AND [Subject] IS NULL) OR ([Subject] = @" +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Subject, int Original_Id, string Original_Subject, int Id) {
            if ((Name == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Subject, int Original_Id, string Original_Subject) {
            return this.Update(Name, Subject, Original_Id, Original_Subject, Original_Id);
        }
    }
